...
| **RAM** | 2 GB RAM (+ 2 GB swap) | 4–8 GB RAM | The multiplexed `gateway` (Python + 3 profiles) and `searxng` consume ~1.2–1.8 GB steady-state. 2 GB minimum with swap is required to avoid OOM during `docker build`. |
