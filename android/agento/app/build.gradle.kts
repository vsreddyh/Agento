...
dependencies {
    ...
    // Pinned to the compose-bom 2024.12.01 managed version (unversioned
    // declaration did not resolve on CI). Core holds the common set;
    // extended holds MenuBook/Description/Tune/History/Folder/Alarm.
